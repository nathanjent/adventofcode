...
mod tests {
    #[test]
    fn test1base() {
        assert_eq!(::day08::two_factor_1("input/day08_base.txt", 7, 3),
                6);
    }

    #[test]
    fn test1() {
        assert_eq!(::day08::two_factor_1("input/day08.txt", 50, 6), 0);
    }

    #[test]
    fn test2() {
        assert_eq!(::day08::two_factor_2("input/day08.txt", 50, 6), 0);
    }
}

...
mod tests {
    #[test]
    fn test_base() {
        assert_eq!(::day10::balance_bots_1("input/day10_base.txt"), 30);
    }

    #[test]
    fn test1() {
        assert_eq!(::day10::balance_bots_1("input/day10.txt"), 147);
    }

    #[test]
    fn test2() {
        assert_eq!(::day10::balance_bots_2("input/day10.txt"), 55637);
    }
}
